...
const ProductionStartedModal = ({ isOpen, onClose, productData, onPause, onMarkDone }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Content */}
        <div style={{ padding: '1rem 1.5rem', overflow: 'hidden', flex: 1, display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', marginBottom: '1rem', flexShrink: 0 }}>
            ...
            >
              {/* Product image - white box with red border and red banner */}
              <div
                style={{
                  width: '100%',
                  height: '100%',
          ...
          <div style={{ marginBottom: '1rem', flexShrink: 0 }}>
            ...
            <h3 className={themeClasses.textPrimary} style={{ fontSize: '16px', fontWeight: '600', marginBottom: '0.75rem', marginTop: 0 }}>
              Quality Checks
            </h3>
          ...
          <div style={{ flexShrink: 0 }}>
            ...
            >
              ...
              <p className={themeClasses.textSecondary} style={{ fontSize: '14px', margin: 0, lineHeight: '1.5', paddingLeft: '44px' }}>
