...
const DesignTable = ({ 
  ...
  const stages = [
    ...
    { key: 'aplus', label: 'A+' },
    { key: 'wsite', label: 'W-SITE' },
  ];

  const handleProductClick = (product) => {
    // Navigate to product detail page with product data and return path
    navigate('/dashboard/products/catalog/detail', { 
      state: { 
        ...
        returnPath: '/dashboard/team/design', // Return to Design page when back button is clicked
