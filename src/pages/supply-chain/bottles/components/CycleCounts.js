      ...
      <div className="p-6">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <button
              type="button"
              onClick={() => navigate('/dashboard/supply-chain/bottles')}
            ...
            <h1 className="text-xl font-semibold text-gray-900">Bottle Cycle Counts</h1>
          </div>
            ...
            >
              ...
              <div className="px-6 py-6 flex gap-6 justify-center">
                ...
                <div className="flex flex-col items-center bg-white border border-gray-200 rounded-lg p-6" style={{ width: '240px' }}>
                  ...
                  <p className="text-sm text-gray-500 text-center mb-4">A quick, daily task to count a random selection of bottles.</p>
                  <button
                    type="button"
                ...
                <div className="flex flex-col items-center bg-white border border-gray-200 rounded-lg p-6 relative" style={{ width: '240px' }}>
                  ...
                  <p className="text-sm text-gray-500 text-center mb-4">A complete count of all bottles in an upcoming shipment.</p>
                  <button
                    type="button"
                ...
                <div className="flex flex-col items-center bg-white border border-gray-200 rounded-lg p-6" style={{ width: '240px' }}>
                  ...
                  <p className="text-sm text-gray-500 text-center mb-4">A comprehensive count of every bottle in your inventory.</p>
                  <button
                    type="button"
